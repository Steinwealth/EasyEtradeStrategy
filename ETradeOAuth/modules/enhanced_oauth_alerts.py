...
class EnhancedOAuthAlerts:
    ...
    async def _send_token_expiry_alert(self) -> bool:
        ...
        try:
            ...
            message = f"""🌙 **OAuth Token Expiry Alert** - {now_pt.strftime('%H:%M PT')}

⚠️ **Action Required**: E*TRADE tokens just expired at midnight ET

**Next Steps:**
1. Visit the OAuth web app
2. Click "Renew Production Tokens"
3. Complete the authorization flow
4. Tokens will be automatically renewed

**Web App**: [OAuth Manager](https://etrade-strategy.web.app)

**Status**: Tokens expired - renewal required
**Expired**: Midnight ET (just now)
**Keep-Alive**: Running every 90 minutes until renewal

**Fallback**: If not renewed, you'll get another alert at 7:30am ET (1 hour before market open)"""
